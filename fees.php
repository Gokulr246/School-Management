...
?>
        <div id="page-wrapper"style="background-image: url('school1.jpg');  background-repeat: no-repeat; background-size: cover;">
            <div id="page-inner"style="background-image: url('school1.jpg');  background-repeat: no-repeat; background-size: cover;">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"style="color:white;">Fees  
...
<fieldset class="scheduler-border" >
    <legend  class="scheduler-border"style="color:white;">Search:</legend>
<form class="form-inline" role="form" id="searchform">
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="email"style="color:white;"> Date Of Joining </label>
    <input type="text" class="form-control" id="doj" name="doj" >
  </div>
  
  <div class="form-group">
    <label for="email"style="color:white;"> Grade </label>
