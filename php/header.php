...
<body>
    <div id="wrapper">
        ...
        <div style="float:right;background-color:#6600cc;color:white;padding:25px;">
...
<span id='ct' ></span>
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"style="background-color:brown;">Tiger School</a>
            </div>
                ...
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div text-center">
                            ...
                            <h5 style="color:LIGHTBLUE;"><?php echo $_SESSION['rainbow_name'];?></h5>
                        </div>
